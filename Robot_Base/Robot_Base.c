...
void main (void)
{
	...
	//servo1 = 100; // Example: Set to 100 (shorter pulse, lower duty cycle)
    //servo2 = 180; // Example: Set to 180 (longer pulse, higher duty cycle)
	...
	OUTPIN4=0;
		...
		if (strcmp(buff,"!10001!10001!10001!") == 0)
		{
