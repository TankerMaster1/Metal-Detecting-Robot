...
{    
	...
	InitPinADC(0,5); // Configure p3.2 as analog input
	InitPinADC(0,6); // Configure p3.1 as analog input
	InitADC();
	...
	*/
	...
	//////////////////////////////////////////
        ...
        */
		...
		/////////////////////
		                 //123456789012345678			
		if ((strcmp(buff, "444444444444444444@") == 0) || (strcmp(buff, "@444444444444444444") == 0) || (strcmp(buff, "444444444444444444!") == 0) || (strcmp(buff, "!444444444444444444") == 0))
		{
			printf("hi");
...
//$/$$$/$/$/$$/$/$///$//////////////////
		...
		if (automaticMode == 1) {
			...
			//srand(j);                    //random value generation
				
				
				
			}
			if ((v1 > 23000) || (v2 > 10000)) {
		       detectPerimeter();
		    }
